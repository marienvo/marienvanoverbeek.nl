...
(function (t) {
  ...
  var e,
    ...
    m = function () {
      ...
      if (t.easing) {
        for (a in f) t.easing[a] = c(f[a]);
        m = !1;
      }
    };
  (t.fn.animate = function (s, n, l, h) {
    if (((s = s || {}), m && (m(), !e || !i))) return r.call(this, s, n, l, h);
    if (
      !a ||
      s.skipGSAP === !0 ||
      ("object" == typeof n && "function" == typeof n.step)
    )
      return r.call(this, s, n, l, h);
    var c,
      p,
      d,
      g,
    ...
    for (p in s) {
      if (
        ...
        "show" === c ||
          "hide" === c ||
          "toggle" === c ||
          (-1 !== _.indexOf(p) && -1 !== _.indexOf("," + p + ",")))
      )
        return r.call(this, s, n, l, h);
      y[-1 === p.indexOf("-") ? p : t.camelCase(p)] = c;
    }
    if (w) {
      (y = o(y)), (g = []);
      for (p in w)
      ...
      v.queue !== !1
        ? (T.queue(v.queue, d),
          "function" == typeof v.old &&
            t(T[T.length - 1]).queue(v.queue, function (t) {
              v.old.call(T), t();
            }))
        : d.call(T),
      T
