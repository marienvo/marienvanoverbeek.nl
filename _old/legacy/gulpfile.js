...
gulp.task('images', function () {
  // Copy images
  gulp.src(['resources/images/**/*.{png,jpg}'])
...
gulp.task('twig', function () {
  ...
  folders.map(function (folder) {
    ...
    files.map(function (file) {
      ...
      gulp.src(['resources/views/_' + folder + '.twig'])
          .pipe(twig({
            data: context
          }))
...
gulp.task('default', function () {
  ...
  gulp.watch([
    'resources/views/**/*.{twig,svg}',
    'resources/data/**/*.{json,md}'
  ], ['twig', reload])
  gulp.watch(['resources/styles/**/*.{sass,scss,less,css,hbs}'], ['styles', 'sasslint', reload])
...
gulp.task('codacy', function codacyTask () {
  return gulp
      .src(['node_modules/.bin/codacy-coverage'], { read: false })
      .pipe(codacy({
